...
export default function Home() {
   return <div>
     ...
     <Responsivecontainer isMobile={false}>
      <Gallery projectname="Orgami" description="Coming Soon. The first IOS app I've made, the focus to help people struggling with addictions find help near them." languages={["react native, firebase, crypto-js "]} projectimg={"/zamora.png"} icons={[{icon:"fa-brands fa-github-alt", link:"https://github.com/rjsiinghhh/iphoneapp" }]} />
