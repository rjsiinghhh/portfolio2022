...
export default function Home() {
   return <div>
     ...
     <Responsivecontainer isMobile={false}>
      ...
      <Mobilegallery projectname="The Zamora Project" description="An online property manager used to track expenses, work notes, and give map details about the real estate." languages={["react", "d3", "express", "postgres", "bootstrap"]} projecturl="https://zamoraproject.netlify.app/" projectimg="/zamora.png" icons={[{ icon: "fa-brands fa-github-alt" }, { icon: "fa-solid fa-share" }]} link="https://zamoraproject.netlify.app/" reverse />
